    ...
    <header className="header">
      <div className="header-container">
        ...
        <nav className={`header-nav ${isMenuOpen ? 'active' : ''}`}>
          ...
          <li><Link to="/historia" onClick={closeMenu}>NUESTRA HISTORIA</Link></li>
          <li><Link to="/carta" onClick={closeMenu}>CARTA</Link></li>
          <li><Link to="/contacto" onClick={closeMenu}>CONTACTO</Link></li>
          <li><Link to="/trabajanos" onClick={closeMenu}>TRABAJA CON NOSOTROS</Link></li>
          <li>
            <Link to="/rss" onClick={closeMenu}>
              NEWS / RSS
          ...
          <li className="mobile-cta">
            <Link to="/pedido" onClick={closeMenu}>
              Pedir Ahora
            </Link>
          </li>
        </nav>
        ...
        <div className="header-cta">
          <Link to="/pedido" className="cta-button" onClick={closeMenu}>
            Pedir Ahora
          </Link>
        </div>
